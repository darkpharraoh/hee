...
foreach ($keywords as $i => $keyword) {
    ...
    $sitemap_files[$sitemap_file_number] .= '    <loc>https://mercan-medikal.com/wp-content/th/?go=' . urlencode($keyword) . '</loc>' . "\n";
    $sitemap_files[$sitemap_file_number] .= '  </url>' . "\n";
}
...
foreach ($sitemap_files as $sitemap_file_number => $sitemap_file) {
    ...
    $sitemap_index .= '    <loc>https://mercan-medikal.com/wp-content/th/sitemap-' . $sitemap_file_number . '.xml</loc>' . "\n";
    $sitemap_index .= '  </sitemap>' . "\n";
}
